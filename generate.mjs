...
.ca-nav .brand{display:flex;align-items:center;flex-shrink:0;text-decoration:none}.ca-nav .brand img{height:52px;width:auto;display:block}
...
.hero .brand-logo{height:104px;width:auto;display:block;margin:0 auto 26px;filter:drop-shadow(0 4px 18px rgba(0,0,0,.5))}
@media(max-width:640px){.hero .brand-logo{height:72px;margin-bottom:20px}}
