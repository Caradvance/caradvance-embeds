...
window.BIZ = (function () {
  ...
  var CARS = [
    { modell:'BMW 330e M Sport',                marka:'BMW',           karosszeria:'Limuzin', km:'62 000 km',  teljesitmeny:'292 LE', valto:'Automata', uzemanyag:'Plug-in hibrid', evjarat:'03/2021', hajtas:'Hátsókerékhajtás',      eur:32000, seller:'sos',           img:'' },
    { modell:'Audi Q5 40 TDI quattro',          marka:'Audi',          karosszeria:'SUV',     km:'78 000 km',  teljesitmeny:'204 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'06/2020', hajtas:'Összkerékhajtás',      eur:34000, seller:'elelmiszerbank', img:'' },
    { modell:'Mercedes-Benz C 220 d',           marka:'Mercedes-Benz', karosszeria:'Kombi',   km:'95 000 km',  teljesitmeny:'194 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'01/2020', hajtas:'Hátsókerékhajtás',      eur:28000, seller:'bator',         img:'' },
    { modell:'Volkswagen Passat 2.0 TDI Elegance', marka:'Volkswagen', karosszeria:'Kombi',   km:'110 000 km', teljesitmeny:'190 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'09/2019', hajtas:'Elsőkerékhajtás',       eur:24000, seller:'maltai',        img:'' },
    { modell:'BMW X3 xDrive20d',                marka:'BMW',           karosszeria:'SUV',     km:'84 000 km',  teljesitmeny:'190 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'05/2020', hajtas:'Összkerékhajtás',      eur:39000, seller:'rex',           img:'' },
    { modell:'Volvo XC60 B4',                   marka:'Volvo',         karosszeria:'SUV',     km:'67 000 km',  teljesitmeny:'197 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'11/2021', hajtas:'Összkerékhajtás',      eur:42000, seller:'heimpal',       img:'' },
    { modell:'Škoda Superb 2.0 TDI L&K',        marka:'Škoda',         karosszeria:'Kombi',   km:'120 000 km', teljesitmeny:'190 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'02/2019', hajtas:'Összkerékhajtás',      eur:22000, seller:'patent',        img:'' },
    { modell:'Audi A6 45 TFSI',                 marka:'Audi',          karosszeria:'Limuzin', km:'58 000 km',  teljesitmeny:'245 LE', valto:'Automata', uzemanyag:'Benzin',         evjarat:'07/2021', hajtas:'Összkerékhajtás',      eur:44000, seller:'sos',           img:'' },
    { modell:'BMW 520d Touring',                marka:'BMW',           karosszeria:'Kombi',   km:'99 000 km',  teljesitmeny:'190 LE', valto:'Automata', uzemanyag:'Dízel',          evjarat:'04/2020', hajtas:'Hátsókerékhajtás',      eur:30000, seller:'elelmiszerbank', img:'' },
    { modell:'Tesla Model 3 Long Range',        marka:'Tesla',         karosszeria:'Limuzin', km:'71 000 km',  teljesitmeny:'440 LE', valto:'Automata', uzemanyag:'Elektromos',     evjarat:'10/2021', hajtas:'Összkerékhajtás',      eur:36000, seller:'bator',         img:'' }
  ];
