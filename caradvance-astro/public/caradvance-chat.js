...
/* brandrow-even-grid */
;(function(){var css='.stat-logos.ca-brandrow{display:grid!important;grid-template-columns:repeat(5,1fr)!important;gap:0!important;align-items:center!important;justify-items:center!important;width:100%!important;overflow:visible!important;padding-top:20px!important}.stat-logos.ca-brandrow .ca-brk{display:none!important}.stat-logos.ca-brandrow img{max-width:100%!important;width:auto!important;object-fit:contain!important;filter:grayscale(1)!important;opacity:.62!important;transition:.2s!important}.stat-logos.ca-brandrow img[alt="BMW"]{height:30px!important}.stat-logos.ca-brandrow img[alt="Mercedes-Benz"]{height:40px!important}.stat-logos.ca-brandrow img[alt="Porsche"]{height:36px!important}.stat-logos.ca-brandrow img[alt="Audi"]{height:22px!important}.stat-logos.ca-brandrow img[alt="MINI"]{height:28px!important}';var s=document.createElement('style');s.id='ca-brandcss';s.textContent=css;(document.head||document.documentElement).appendChild(s);})();
