...
/* brandrow-even-grid */
;(function(){var css='.stat-logos.ca-brandrow{display:grid!important;grid-template-columns:repeat(5,1fr)!important;gap:0!important;align-items:center!important;justify-items:center!important;width:100%!important;overflow:visible!important}.stat-logos.ca-brandrow .ca-brk{display:none!important}.stat-logos.ca-brandrow img{max-width:100%!important;width:auto!important;object-fit:contain!important}.stat-logos.ca-brandrow img[alt="BMW"]{height:34px!important}.stat-logos.ca-brandrow img[alt="Mercedes-Benz"]{height:34px!important}.stat-logos.ca-brandrow img[alt="Porsche"]{height:32px!important}.stat-logos.ca-brandrow img[alt="Audi"]{height:26px!important}.stat-logos.ca-brandrow img[alt="MINI"]{height:30px!important}';var s=document.createElement('style');s.id='ca-brandcss';s.textContent=css;(document.head||document.documentElement).appendChild(s);})();
