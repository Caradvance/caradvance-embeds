...
/* brandrow-even-grid */
;(function(){var css='.stat-logos.ca-brandrow{display:flex!important;flex-wrap:nowrap!important;gap:14px!important;justify-content:center!important;align-items:center!important;width:100%!important;overflow:visible!important;padding-top:20px!important}.stat-logos.ca-brandrow .ca-brk{display:none!important}.stat-logos.ca-brandrow img{filter:none!important;opacity:1!important;width:auto!important;max-width:none!important;object-fit:contain!important}.stat-logos.ca-brandrow img[alt="BMW"]{height:34px!important}.stat-logos.ca-brandrow img[alt="Mercedes-Benz"]{height:32px!important}.stat-logos.ca-brandrow img[alt="Porsche"]{height:32px!important}.stat-logos.ca-brandrow img[alt="Audi"]{height:22px!important}.stat-logos.ca-brandrow img[alt="MINI"]{height:26px!important;margin-left:-8px!important}';var s=document.createElement('style');s.id='ca-brandcss';s.textContent=css;(document.head||document.documentElement).appendChild(s);})();

/* card-km-unit */
;(function(){function addKm(){var els=document.querySelectorAll('.specs');els.forEach(function(el){if(el.getAttribute('data-km'))return;var t=el.textContent;var m=t.match(/^(\s*)(\d[\d\s .]*?)(\s*\u00b7)/);if(m&&!/\bkm\b/i.test(t)){var rest=t.slice(m[1].length+m[2].length);el.textContent=m[1]+m[2].trim()+' km'+rest;el.setAttribute('data-km','1');}});}var n=0;var iv=setInterval(function(){addKm();if(++n>24)clearInterval(iv);},250);})();

/* charity-reorder */
;(function(){function bc(el){while(el&&el.parentElement&&el.parentElement!==document.body)el=el.parentElement;return el;}function mv(){var c=document.getElementById('jotekonysag-blokk'),a=document.getElementById('autoink');if(!c||!a)return false;var cb=bc(c),ab=bc(a);if(cb&&ab&&cb.parentElement===document.body&&ab.parentElement===document.body&&ab.previousElementSibling!==cb){document.body.insertBefore(cb,ab);}return true;}var n=0;var iv=setInterval(function(){mv();if(++n>60)clearInterval(iv);},80);})();
