...
/* charity-reorder */
;(function(){function mv(){var c=document.getElementById('jotekonysag-blokk'),a=document.getElementById('autoink');if(!c||!a)return false;if(a.previousElementSibling!==c)a.parentNode.insertBefore(c,a);return true;}var n=0;var iv=setInterval(function(){mv();if(++n>60)clearInterval(iv);},80);})();
