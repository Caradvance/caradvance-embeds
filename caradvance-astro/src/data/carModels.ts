...
export const carModels: Record<string, CarModel> = {
  ...
  'ix3-elektromos': {
    ...
    design: {
      ...
      img: '/bmw/bmw-ix3-kulso.webp', alt: 'BMW iX3 külső – Neue Klasse formanyelv, elölnézet',
    },
    interior: {
    ...
    variants: [
      { key: 'ix3-50', label: 'BMW iX3 50 xDrive', fuel: 'Elektromos', power: '469 LE (345 kW)', torque: '645 Nm', drive: 'xDrive összkerék / 1 fok.', accel: '4,9 mp', vmax: '210 km/h', cons: '~18,5 kWh/100 km', boot: '520 liter', rec: 'Neue Klasse csúcs-EV, akár 805 km hatótáv', img: '/bmw/bmw-ix3-elolnezet.webp', alt: 'BMW iX3 50 xDrive – elölnézet' },
    ],
    gallery: [
      { img: '/bmw/bmw-ix3-oldalnezet.webp', alt: 'BMW iX3 oldalnézet, menet közben' },
      { img: '/bmw/bmw-ix3-hatso-nezet.webp', alt: 'BMW iX3 hátsó nézet' },
  ...
  'x5-dizel': {
    ...
    design: {
      ...
      img: '/bmw/bmw-x5-side.webp', alt: 'BMW X5 külső – oldalnézet, új G65 formanyelv',
    },
    interior: {
      ...
      img: '/bmw/bmw-x5-belso.webp', alt: 'BMW X5 belső tér – Panoramic Vision kijelző',
    },
    prose: {
    ...
    variants: [
      { key: 'x5-40', label: 'BMW X5 xDrive40', fuel: 'Benzin (mild-hybrid)', power: '400 LE (294 kW)', torque: '580 Nm', drive: 'xDrive összkerék / 8 fok. aut.', accel: '5,3 mp', vmax: '250 km/h', cons: '~8,5 l/100 km', boot: '620 liter', rec: 'Kulturált, erős benzines belépő', img: '/bmw/bmw-x5-front.webp', alt: 'BMW X5 xDrive40 – elölnézet' },
    ],
    gallery: [
      { img: '/bmw/bmw-x5-front.webp', alt: 'BMW X5 elölnézet, menet közben' },
      { img: '/bmw/bmw-x5-coast.webp', alt: 'BMW X5 tengerparti úton, menet közben' },
      { img: '/bmw/bmw-x5-sunset.webp', alt: 'BMW X5 naplementében' },
      { img: '/bmw/bmw-x5-side.webp', alt: 'BMW X5 oldalnézet, hegyi úton' },
      { img: '/bmw/bmw-x5-rear.webp', alt: 'BMW X5 hátsó nézet, menet közben' },
      { img: '/bmw/bmw-x5-rear2.webp', alt: 'BMW X5 hátsó háromnegyedes nézet' },
      { img: '/bmw/bmw-x5-beach.webp', alt: 'BMW X5 a tengerparton' },
      { img: '/bmw/bmw-x5-villa.webp', alt: 'BMW X5 modern villa előtt' },
      { img: '/bmw/bmw-x5-villa-rear.webp', alt: 'BMW X5 hátsó nézet, villa előtt' },
      { img: '/bmw/bmw-x5-feher-eleje.webp', alt: 'BMW X5 M60e fehér színben, elölnézet' },
      { img: '/bmw/bmw-x5-feher-hegy.webp', alt: 'BMW X5 M60e fehér színben, hegyi úton' },
      { img: '/bmw/bmw-x5-feher-oldal.webp', alt: 'BMW X5 M60e fehér színben, oldalnézet' },
      { img: '/bmw/bmw-x5-feher-part.webp', alt: 'BMW X5 M60e fehér színben, tengerparti úton' },
      { img: '/bmw/bmw-x5-feher-hatso.webp', alt: 'BMW X5 M60e fehér színben, hátsó nézet' },
      { img: '/bmw/bmw-x5-feher-felni.webp', alt: 'BMW X5 M60e M könnyűfém keréktárcsa, piros féknyereg' },
      { img: '/bmw/bmw-x5-cockpit.webp', alt: 'BMW X5 vezetőtér – kormány és Panoramic Vision' },
      { img: '/bmw/bmw-x5-konzol.webp', alt: 'BMW X5 középkonzol, prémium kialakítás' },
      { img: '/bmw/bmw-x5-grille.webp', alt: 'BMW X5 veserács, közeli nézet' },
      { img: '/bmw/bmw-x5-taillight.webp', alt: 'BMW X5 hátsó lámpa, közeli nézet' },
      { img: '/bmw/bmw-x5-wheel.webp', alt: 'BMW X5 könnyűfém keréktárcsa, közeli nézet' },
    ],
    faq: [
