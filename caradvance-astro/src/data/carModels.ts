...
export const carModels: Record<string, CarModel> = {
  '1erb-benzin': {
    ...
    gallery: [
      { img: '/bmw/bmw-1es-menet-kozben.webp', alt: 'BMW 1-es elölnézet, menet közben' },
      { img: '/bmw/bmw-1es-oldalnezet.webp', alt: 'BMW 1-es oldalnézet' },
      { img: '/bmw/bmw-1es-hegyi-uton.webp', alt: 'BMW 1-es hegyi úton, menet közben' },
      { img: '/bmw/bmw-1es-m-sport-kulso.webp', alt: 'BMW 1-es M Sport külső, hátsó háromnegyedes nézet' },
      { img: '/bmw/bmw-120-elolnezet.webp', alt: 'BMW 120 elölnézet' },
      { img: '/bmw/bmw-120d-elolnezet.webp', alt: 'BMW 120d elölnézet' },
      { img: '/bmw/bmw-1es-m-felni-feknyereg.webp', alt: 'BMW 1-es M könnyűfém keréktárcsa, féknyereg' },
      { img: '/bmw/bmw-118-elolnezet.webp', alt: 'BMW 118 elölnézet' },
      { img: '/bmw/bmw-1es-m-sport-elolnezet.webp', alt: 'BMW 1-es M Sport elölnézet' },
      { img: '/bmw/bmw-1es-muszerfal.webp', alt: 'BMW 1-es műszerfal, digitális kijelzők' },
      { img: '/bmw/bmw-1es-belso-ter-curved-display.webp', alt: 'BMW 1-es belső tér, Curved Display' },
      { img: '/bmw/bmw-1es-sport-ulesek.webp', alt: 'BMW 1-es sportülések, prémium utastér' },
    ],
    faq: [
  ...
  '2eratb-benzin': {
    ...
    gallery: [
      { img: '/bmw/bmw-2es-active-tourer-kek-menet-kozben.webp', alt: 'BMW 2-es Active Tourer, menet közben' },
      { img: '/bmw/bmw-2es-active-tourer-oldalnezet.webp', alt: 'BMW 2-es Active Tourer oldalnézet' },
      { img: '/bmw/bmw-2es-active-tourer-hatso-nezet.webp', alt: 'BMW 2-es Active Tourer hátsó nézet' },
      { img: '/bmw/bmw-2es-active-tourer-kek-topart.webp', alt: 'BMW 2-es Active Tourer tópartnál' },
      { img: '/bmw/bmw-2es-active-tourer-kek-hatso.webp', alt: 'BMW 2-es Active Tourer hátsó háromnegyedes nézet' },
      { img: '/bmw/bmw-2es-active-tourer-kulso.webp', alt: 'BMW 2-es Active Tourer külső, elölnézet' },
      { img: '/bmw/bmw-2es-active-tourer-veserac.webp', alt: 'BMW 2-es Active Tourer veserács' },
      { img: '/bmw/bmw-2es-active-tourer-felni.webp', alt: 'BMW 2-es Active Tourer könnyűfém keréktárcsa' },
      { img: '/bmw/bmw-220d-active-tourer-elolnezet.webp', alt: 'BMW 220d Active Tourer elölnézet' },
      { img: '/bmw/bmw-2es-active-tourer-muszerfal.webp', alt: 'BMW 2-es Active Tourer műszerfal' },
      { img: '/bmw/bmw-2es-active-tourer-ulesek.webp', alt: 'BMW 2-es Active Tourer ülések' },
      { img: '/bmw/bmw-2es-active-tourer-belso-ter.webp', alt: 'BMW 2-es Active Tourer belső tér' },
    ],
    faq: [
  ...
  '2ergc-benzin': {
    ...
    gallery: [
      { img: '/bmw/bmw-2es-gran-coupe-oldalnezet.webp', alt: 'BMW 2-es Gran Coupé oldalnézet' },
      { img: '/bmw/bmw-2es-gran-coupe-hatso-nezet.webp', alt: 'BMW 2-es Gran Coupé hátsó nézet' },
      { img: '/bmw/bmw-2es-gran-coupe-kulso.webp', alt: 'BMW 2-es Gran Coupé külső, elölnézet háromnegyedből' },
      { img: '/bmw/bmw-220-gran-coupe-elolnezet.webp', alt: 'BMW 220 Gran Coupé elölnézet' },
      { img: '/bmw/bmw-m235-gran-coupe-elolnezet.webp', alt: 'BMW M235 Gran Coupé elölnézet' },
      { img: '/bmw/bmw-2es-gran-coupe-m235-elolnezet.webp', alt: 'BMW M235 Gran Coupé, elölnézet háromnegyedből' },
      { img: '/bmw/bmw-2es-gran-coupe-veserac-iconic-glow.webp', alt: 'BMW 2-es Gran Coupé Iconic Glow veserács' },
      { img: '/bmw/bmw-2es-gran-coupe-felni.webp', alt: 'BMW 2-es Gran Coupé könnyűfém keréktárcsa' },
      { img: '/bmw/bmw-m235-negy-vegkifuvo.webp', alt: 'BMW M235 négy végkifúvó, sport kipufogó' },
      { img: '/bmw/bmw-2es-gran-coupe-muszerfal.webp', alt: 'BMW 2-es Gran Coupé műszerfal' },
      { img: '/bmw/bmw-2es-gran-coupe-belso-ter.webp', alt: 'BMW 2-es Gran Coupé belső tér' },
  ...
  '2ercb-benzin': {
    ...
    gallery: [
      { img: '/bmw/bmw-2es-coupe-oldalnezet.webp', alt: 'BMW 2-es Coupé oldalnézet' },
      { img: '/bmw/bmw-2es-coupe-hatso-nezet.webp', alt: 'BMW 2-es Coupé hátsó nézet' },
      { img: '/bmw/bmw-2es-coupe-kulso.webp', alt: 'BMW 2-es Coupé külső, elölnézet háromnegyedből' },
      { img: '/bmw/bmw-220i-coupe-elolnezet.webp', alt: 'BMW 220i Coupé elölnézet' },
      { img: '/bmw/bmw-2es-coupe-veserac.webp', alt: 'BMW 2-es Coupé veserács' },
      { img: '/bmw/bmw-2es-coupe-felni.webp', alt: 'BMW 2-es Coupé könnyűfém keréktárcsa' },
      { img: '/bmw/bmw-m240i-coupe-elolnezet.webp', alt: 'BMW M240i Coupé elölnézet' },
      { img: '/bmw/bmw-2es-coupe-muszerfal.webp', alt: 'BMW 2-es Coupé műszerfal' },
      { img: '/bmw/bmw-2es-coupe-belso-ter.webp', alt: 'BMW 2-es Coupé belső tér' },
  ...
  'ix3-elektromos': {
    ...
    gallery: [
      ...
      { img: '/bmw/bmw-ix3-kulso.webp', alt: 'BMW iX3 külső, Neue Klasse formanyelv' },
  ...
  'x5-dizel': {
    ...
    design: {
      ...
      img: '/bmw/bmw-x5-studio-elol2.webp', alt: 'BMW X5 külső – elölnézet, új G65 formanyelv',
    },
    interior: {
      ...
      img: '/bmw/bmw-x5-studio-cockpit.webp', alt: 'BMW X5 belső tér – Panoramic Vision kijelző',
    },
    prose: {
  ...
  'm4-benzin': {
    slug: 'm4-benzin',
    brand: 'BMW', brandKey: 'bmw', brandLogo: '/bmw-hero-logo.png',
    name: 'BMW M4', modelCode: 'G82',
    title: 'BMW M4 Coupé (G82) — akár 530 LE, M xDrive | egyedi rendelés Németországból | CarAdvance',
    description: 'Új BMW M4 Coupé (G82) egyedi rendelése Németországból — S58 M TwinPower Turbo sor-6, akár 530 LE, M xDrive, M karbon tető és kagylóülések. Kulcsrakész behozatal, akár 19% német áfával. Ár, felszereltség, tartós bérlet.',
    netEur: 82773,
    ...
    chips: ['Nagy teljesítményű kupé', 'akár 530 LE', 'M xDrive', 'M karbon'],
    yearChip: '2026 · Németország',
    bodyType: 'M Sportkupé',
    overviewH2: 'Új BMW M4 Coupé Németországból, egyedi rendelésre',
    overviewLead: 'A <strong>BMW M4 Coupé</strong> a márka nagy teljesítményű kupéja, a <strong>G82</strong> generációban: az <strong>S58 M TwinPower Turbo</strong> sorhatos turbómotor <strong>480–530 LE</strong> között, kézi váltóval, automatával vagy <strong>M xDrive</strong> összkerékhajtással. A CarAdvance-nél pontosan azt az M4-et rendeljük meg neked, amelyiket szeretnéd — új autóként, gyári M felszereltséggel, <a href="/beszerzesi-folyamat">Németországból, kulcsrakész behozatallal</a>. Nem szeretnél venni? Az M4 <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető.',
    highlights: [
      { icon: '◈', title: 'Akár 530 LE, M xDrive', text: 'A csúcs M4 Competition Coupé M xDrive 530 LE-vel és 650 Nm-rel 3,5 mp alatt gyorsul 100 km/h-ra — összkerékhajtással.' },
      { icon: '⚙', title: 'S58 sor-6 turbó', text: 'A 3,0 literes M TwinPower Turbo sorhatos: kézi 6 fokozatú váltóval (480 LE) vagy 8 fokozatú M Steptronic automatával (510–530 LE).' },
      { icon: '◆', title: 'M karbon a gyárból', text: 'Opcionális M karbon tető, M karbon kagylóülések és M kompozit/karbon-kerámia fékek — pontosan úgy, ahogy konfigurálod.' },
      { icon: '€', title: 'Kedvező német ár', text: 'Magánszemélyként akár 19% német áfával — egy M4-nél ez több millió forint megtakarítást jelenthet.' },
    ],
    design: {
      h3: 'Agresszív M forma, karbon részletek',
      text: 'Az M4 kifejezetten sportos: markáns függőleges veserács, keskeny Matrix LED fényszórók, kiszélesített sárvédők és jellegzetes M kipufogóvégek. Választható M karbon tető és M karbon kültéri csomag. Pontosan úgy konfigurálva, ahogy te szeretnéd — színben, keréktárcsában és felszereltségben.',
      bullets: ['Adaptív LED / M Matrix fényszórók', 'Opcionális M karbon tető és karbon kültéri csomag', '18–19&quot; kovácsolt M könnyűfém keréktárcsák'],
      img: '/bmw/bmw-m4-studio-oldal.webp', alt: 'BMW M4 Coupé külső – oldalnézet, G82 M formanyelv',
    },
    interior: {
      h3: 'Vezetőközpontú M utastér',
      text: 'Az M4 utastere a vezetőre hangolt: BMW Curved Display, M-specifikus kijelzők és menük, M kormánykerék piros M gombokkal, valamint választható M karbon kagylóülések. Minden a vezetési élményről szól, a mindennapi használhatóság feláldozása nélkül.',
      bullets: ['BMW Curved Display + M Mode gombok', 'M kormánykerék, M1/M2 gyorsgombok', 'Opcionális M karbon kagylóülések'],
      img: '/bmw/bmw-m4-muszerfal.webp', alt: 'BMW M4 belső tér – M műszerfal és Curved Display',
    },
    prose: {
      h2: 'Új BMW M4 Németországból — miért éri meg?',
      blocks: [
        { html: 'A <strong>BMW M4</strong> a márka egyik ikonikus M modellje: a hátsó- és összkerékhajtás, a sorhatos turbómotor és a hétköznap is vállalható kupékaross-zéria együtt adják a valódi M élményt. Ha új autót szeretnél, a német piac kínálata nagyságrendekkel szélesebb a hazainál — így pontosan azt a hajtásláncot, felszereltséget, színt és konfigurációt találjuk meg neked, amit elképzeltél. A CarAdvance 2003 óta hozza be a prémium autókat Németországból, <a href="/beszerzesi-folyamat">kulcsrakészen, teljes ügyintézéssel</a>.' },
        { h3: 'Melyik M4 való nekem?', html: 'A <strong>M4 Coupé</strong> alapmodell <strong>6 fokozatú kézi váltóval</strong> és hátsókerékhajtással a purista választás (480 LE). A <strong>M4 Competition Coupé</strong> 8 fokozatú M Steptronic automatával és 510 LE-vel gyorsabb és kényelmesebb, a csúcs <strong>M4 Competition Coupé M xDrive</strong> pedig 530 LE-vel és összkerékhajtással minden körülmények között kimagaslóan gyors (0–100 km/h 3,5 mp). Segítünk kiválasztani a hozzád illő kivitelt.' },
        { h3: 'Mennyibe kerül egy új BMW M4?', html: 'A <strong>BMW M4 ára</strong> a kiviteltől és a felszereltségtől függ. Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár <strong>19%-os német áfával</strong> vásárolhatsz a hazai 27% helyett — egy M modellnél ez több millió forintos megtakarítást is jelenthet. Pontos, személyre szabott árajánlatért keress minket.' },
        { h3: 'Megvásárolod, lízingeled vagy béreled?', html: 'Ahogy neked a legjobb: az egyedi rendelés mellett az M4 elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha pedig nem szeretnél tulajdonolni, a modell <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet. Nyitottabb tetőt vagy négyajtós M-et keresel? Nézd meg a <a href="/egyedi-auto-rendeles?brand=bmw">BMW M4 Cabrio, M3 és M2</a> modelleket is.' },
      ],
    },
    variants: [
      { key: 'm4-comp-xdrive', label: 'BMW M4 Competition Coupé M xDrive', fuel: 'Benzin', power: '530 LE (390 kW)', torque: '650 Nm', drive: 'M xDrive összkerék / 8 fok. M Steptronic', accel: '3,5 mp', vmax: '250 km/h (M Driver: 290)', cons: '~10,2 l/100 km', boot: '440 liter', rec: 'A csúcs — összkerékhajtással', img: '/bmw/bmw-m4-studio-elol34.webp', alt: 'BMW M4 Competition Coupé M xDrive – elölnézet' },
      { key: 'm4-comp', label: 'BMW M4 Competition Coupé', fuel: 'Benzin', power: '510 LE (375 kW)', torque: '650 Nm', drive: 'Hátsókerék / 8 fok. M Steptronic', accel: '3,9 mp', vmax: '250 km/h', cons: '~10,0 l/100 km', boot: '440 liter', rec: 'Hátsókerékhajtás, automata', img: '/bmw/bmw-m4-studio-oldal.webp', alt: 'BMW M4 Competition Coupé – oldalnézet' },
      { key: 'm4-base', label: 'BMW M4 Coupé', fuel: 'Benzin', power: '480 LE (353 kW)', torque: '550 Nm', drive: 'Hátsókerék / 6 fok. kézi', accel: '4,2 mp', vmax: '250 km/h', cons: '~9,8 l/100 km', boot: '440 liter', rec: 'Kézi váltó, tiszta vezetőélmény', img: '/bmw/bmw-m4-matrix-led.webp', alt: 'BMW M4 Coupé – Matrix LED fényszóró, elölnézet' },
    ],
    gallery: [
      { img: '/bmw/bmw-m4-studio-elol34.webp', alt: 'BMW M4 Coupé stúdiófotó – elölnézet háromnegyedből' },
      { img: '/bmw/bmw-m4-studio-oldal.webp', alt: 'BMW M4 Coupé stúdiófotó – oldalnézet' },
      { img: '/bmw/bmw-m4-matrix-led.webp', alt: 'BMW M4 Coupé – M Matrix LED fényszóró, elölnézet' },
      { img: '/bmw/bmw-m4-fenyszoro.webp', alt: 'BMW M4 fényszóró, közeli nézet' },
      { img: '/bmw/bmw-m4-carbon-teto.webp', alt: 'BMW M4 M karbon tető, közeli nézet' },
      { img: '/bmw/bmw-m4-fek.webp', alt: 'BMW M4 M fék piros féknyereggel, közeli nézet' },
      { img: '/bmw/bmw-m4-muszerfal.webp', alt: 'BMW M4 utastér – M műszerfal és Curved Display' },
      { img: '/bmw/bmw-m4-ulesek.webp', alt: 'BMW M4 M karbon kagylóülések' },
      { img: '/bmw/bmw-m4-kormany.webp', alt: 'BMW M4 M kormánykerék, közeli nézet' },
    ],
    faq: [
      { q: 'Mennyibe kerül egy új BMW M4 Németországból?', a: 'A BMW M4 nettó listaára a kiviteltől és a felszereltségtől függ, a feltüntetett ártól indul. Magánszemélyként akár 19% német áfával rendelheted a müncheni Caradvance GmbH-n keresztül — pontos árajánlatért keress minket.' },
      { q: 'Milyen kivitelben érhető el az új M4?', a: 'A G82 M4 elérhető M4 Coupé (480 LE, 6 fokozatú kézi, hátsókerék), M4 Competition Coupé (510 LE, automata, hátsókerék) és M4 Competition Coupé M xDrive (530 LE, automata, összkerék) kivitelben. Segítünk kiválasztani a hozzád legjobban illő változatot.' },
      { q: 'Milyen erős és gyors az M4 Competition M xDrive?', a: 'A csúcs M4 Competition Coupé M xDrive az S58 sorhatos turbómotorral 530 LE-t (390 kW) és 650 Nm nyomatékot ad le, M xDrive összkerékhajtással 0-ról 100 km/h-ra 3,5 másodperc alatt gyorsul, végsebessége 250 km/h (M Driver csomaggal 290 km/h).' },
      { q: 'Van kézi váltós BMW M4?', a: 'Igen — az alap M4 Coupé továbbra is elérhető 6 fokozatú kézi váltóval és hátsókerékhajtással, 480 LE teljesítménnyel. A Competition kivitelek 8 fokozatú M Steptronic automatával érkeznek.' },
      { q: 'Mekkora az M4 csomagtartója?', a: 'A BMW M4 Coupé csomagtartója kb. 440 liter — egy nagy teljesítményű kupéhoz kifejezetten használható, hétköznapokra is alkalmas méret.' },
      { q: 'Mennyivel olcsóbb a német áfás vásárlás?', a: 'Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár 19%-os német áfával vásárolhatsz a hazai 27% helyett. A 8 százalékpontnyi különbség egy új BMW M4-nél több millió forintos megtakarítást is jelenthet.' },
      { q: 'Lehet a BMW M4-et lízingelni vagy finanszírozni?', a: 'Igen — a BMW M4 elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha nem szeretnél tulajdonolni, <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet.' },
      { q: 'Bérelhető is a BMW M4?', a: 'Igen — az M4 <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető, egyetlen, kiszámítható havi díjjal, amiben a szerviz és a biztosítás is benne lehet.' },
      { q: 'Mennyi idő a behozatal?', a: 'A kiválasztott konfigurációtól függ, jellemzően néhány hét. A <a href="/beszerzesi-folyamat">beszerzési folyamat</a> minden lépését mi intézzük, a honosítással és forgalomba helyezéssel együtt.' },
    ],
    related: [
      { name: 'BMW M3', href: '/egyedi-auto-rendeles?brand=bmw' },
      { name: 'BMW M2', href: '/egyedi-auto-rendeles?brand=bmw' },
      { name: 'BMW M4 Cabrio', href: '/egyedi-auto-rendeles?brand=bmw' },
      { name: 'BMW X3', href: '/egyedi-auto-rendeles/x3-benzin' },
    ],
    schema: {
      modelName: 'M4 Competition Coupé M xDrive', modelDate: '2026', bodyTypeEn: 'Coupe', doors: 2,
      transmission: '8 fokozatú M Steptronic', drive: 'AllWheelDriveConfiguration',
      fuelType: 'Benzin', engineFuel: 'Benzin', powerKw: 390, torqueNm: 650,
      vmaxKmh: 250, accelSec: 3.5, cargoL: 440, consL: 10.2,
    },
  },
  'xm-hibrid': {
    slug: 'xm-hibrid',
    brand: 'BMW', brandKey: 'bmw', brandLogo: '/bmw-hero-logo.png',
    name: 'BMW XM', modelCode: 'G09',
    title: 'BMW XM (G09) — akár 748 LE M Hybrid | egyedi rendelés Németországból | CarAdvance',
    description: 'Új BMW XM (G09) egyedi rendelése Németországból — M Hybrid plug-in hajtás, XM 50e (476 LE) és a V8-as XM Label (748 LE), M xDrive, M Lounge luxus utastér. Kulcsrakész behozatal, akár 19% német áfával. Ár, felszereltség, tartós bérlet.',
    netEur: 113866,
    ...
    chips: ['Nagy teljesítményű SUV', 'M Hybrid', 'M xDrive', 'akár 748 LE'],
    yearChip: '2026 · Németország',
    bodyType: 'Nagy teljesítményű SUV',
    overviewH2: 'Új BMW XM Németországból, egyedi rendelésre',
    overviewLead: 'A <strong>BMW XM</strong> a BMW M részleg első önálló modellje a legendás <strong>M1</strong> óta — és az M első elektrifikált, nagy teljesítményű autója. A <strong>G09</strong> <strong>M Hybrid</strong> plug-in hajtással érkezik: a belépő <strong>XM 50e</strong> sorhatos motorral 476 LE-t, a csúcs V8-as <strong>XM Label</strong> pedig 748 LE-t ad le. Mindkettő <strong>M xDrive</strong> összkerékhajtással, luxus <strong>M Lounge</strong> utastérrel és tisztán elektromos hatótávval. A CarAdvance-nél pontosan azt az XM-et rendeljük meg neked, amelyiket szeretnéd — új autóként, gyári felszereltséggel, <a href="/beszerzesi-folyamat">Németországból, kulcsrakész behozatallal</a>. Nem szeretnél venni? Az XM <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető.',
    highlights: [
      { icon: '◈', title: 'Akár 748 LE, M Hybrid', text: 'A csúcs XM Label V8-as M TwinPower Turbo + elektromos hajtása 748 LE-vel és 1000 Nm-rel 3,8 mp alatt gyorsul 100 km/h-ra.' },
      { icon: '★', title: 'Önálló M az M1 óta', text: 'Az XM a BMW M első kizárólag M-modellként fejlesztett autója az 1978-as M1 óta — nem egy meglévő modell M-változata.' },
      { icon: '⚡', title: 'Plug-in elektromos hatótáv', text: 'Az M Hybrid hajtás akár ~83 km tisztán elektromos, helyi kibocsátásmentes vezetést tesz lehetővé a városban.' },
      { icon: '€', title: 'Kedvező német ár', text: 'Magánszemélyként akár 19% német áfával — egy XM-nél ez több millió forint megtakarítást is jelenthet.' },
    ],
    design: {
      h3: 'Domináns jelenlét, M-specifikus forma',
      text: 'Az XM minden szemszögből jelenség: hatalmas, választhatóan világító (Iconic Glow) veserács, keskeny osztott fényszórók, izmos arányok és a jellegzetes, függőlegesen egymásra helyezett M dupla kipufogóvégek. Pontosan úgy konfigurálva, ahogy te szeretnéd — színben, keréktárcsában és felszereltségben.',
      bullets: ['Iconic Glow világító veserács', 'Egyedi, M-specifikus karosszéria és fényszórók', '21–23&quot; kovácsolt M könnyűfém keréktárcsák'],
      img: '/bmw/bmw-xm-oldal.webp', alt: 'BMW XM külső – oldalnézet, G09 M formanyelv',
    },
    interior: {
      h3: 'M Lounge, prémium luxus utastér',
      text: 'Az XM utastere ötvözi az M sportosságát a luxussal: ívelt BMW Curved Display, a hátsó sorban a különleges „M Lounge” kialakítás, prizma-struktúrájú Alcantara tetőkárpit és hangulatvilágítás. Nagy teljesítmény és elsőosztályú komfort egyben.',
      bullets: ['BMW Curved Display + M Mode', 'M Lounge hátsó ülésrendszer, prémium bőr', 'Prizma Alcantara tetőkárpit, hangulatvilágítás'],
      img: '/bmw/bmw-xm-muszerfal.webp', alt: 'BMW XM belső tér – M Lounge és Curved Display',
    },
    prose: {
      h2: 'Új BMW XM Németországból — miért éri meg?',
      blocks: [
        { html: 'A <strong>BMW XM</strong> a márka csúcs-teljesítményű, mégis luxus SUV-ja: az M részleg első önálló modellje az M1 óta, egyedülálló formával és plug-in hibrid M Hybrid hajtással. Ha új autót szeretnél, a német piac kínálata nagyságrendekkel szélesebb a hazainál — így pontosan azt a kivitelt, felszereltséget, színt és konfigurációt találjuk meg neked, amit elképzeltél. A CarAdvance 2003 óta hozza be a prémium autókat Németországból, <a href="/beszerzesi-folyamat">kulcsrakészen, teljes ügyintézéssel</a>.' },
        { h3: 'XM 50e vagy XM Label?', html: 'Az <strong>XM 50e</strong> a belépő kivitel: sorhatos M TwinPower Turbo + elektromos hajtással 476 LE, kulturált és hatékony, plug-in hatótávval. A csúcs <strong>XM Label</strong> a 4,4 literes V8-as M motorral és elektromos hajtással 748 LE-t és 1000 Nm-t ad le — a legerősebb közúti BMW M modell. Segítünk kiválasztani a hozzád illő változatot.' },
        { h3: 'Mennyibe kerül egy új BMW XM?', html: 'A <strong>BMW XM ára</strong> a kiviteltől és a felszereltségtől függ. Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár <strong>19%-os német áfával</strong> vásárolhatsz a hazai 27% helyett — egy ekkora autónál ez több millió forintos megtakarítást is jelenthet. Pontos, személyre szabott árajánlatért keress minket.' },
        { h3: 'Megvásárolod, lízingeled vagy béreled?', html: 'Ahogy neked a legjobb: az egyedi rendelés mellett az XM elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha pedig nem szeretnél tulajdonolni, a modell <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet. Klasszikusabb nagy SUV-ot keresel? Nézd meg a <a href="/egyedi-auto-rendeles/x5-dizel">BMW X5</a> és <a href="/egyedi-auto-rendeles/x6-dizel">X6</a> modelleket is.' },
      ],
    },
    variants: [
      { key: 'xm-label', label: 'BMW XM Label', fuel: 'Plug-in hibrid (V8)', power: '748 LE (550 kW)', torque: '1000 Nm', drive: 'M xDrive összkerék / 8 fok. M Steptronic', accel: '3,8 mp', vmax: '250 km/h (M Driver: 270)', cons: '~5,3 l + 25,7 kWh/100 km', boot: '527–1820 liter', rec: 'A csúcs — 748 LE V8 M Hybrid', img: '/bmw/bmw-xm-studio-elol34.webp', alt: 'BMW XM Label – elölnézet' },
      { key: 'xm-50e', label: 'BMW XM 50e', fuel: 'Plug-in hibrid (sor-6)', power: '476 LE (350 kW)', torque: '700 Nm', drive: 'M xDrive összkerék / 8 fok. M Steptronic', accel: '5,1 mp', vmax: '235 km/h (M Driver: 250)', cons: '~4,7 l + 25,4 kWh/100 km', boot: '527–1820 liter', rec: 'Belépő M Hybrid, sorhatos', img: '/bmw/bmw-xm-hatso34.webp', alt: 'BMW XM 50e – hátsó háromnegyedes nézet' },
    ],
    gallery: [
      { img: '/bmw/bmw-xm-studio-elol34.webp', alt: 'BMW XM stúdiófotó – elölnézet háromnegyedből' },
      { img: '/bmw/bmw-xm-oldal.webp', alt: 'BMW XM – oldalnézet' },
      { img: '/bmw/bmw-xm-hatso34.webp', alt: 'BMW XM – hátsó háromnegyedes nézet, M dupla kipufogóvégek' },
      { img: '/bmw/bmw-xm-veserac.webp', alt: 'BMW XM Iconic Glow világító veserács, közeli nézet' },
      { img: '/bmw/bmw-xm-felni.webp', alt: 'BMW XM M könnyűfém keréktárcsa, piros féknyereg' },
      { img: '/bmw/bmw-xm-muszerfal.webp', alt: 'BMW XM utastér – Curved Display és műszerfal' },
      { img: '/bmw/bmw-xm-belso.webp', alt: 'BMW XM M Lounge utastér, hátsó rész' },
      { img: '/bmw/bmw-xm-kormany.webp', alt: 'BMW XM M kormánykerék és középkonzol, közeli nézet' },
      { img: '/bmw/bmw-xm-este.webp', alt: 'BMW XM éjszaka, üdvözlő fényszőnyeggel' },
    ],
    faq: [
      { q: 'Mennyibe kerül egy új BMW XM Németországból?', a: 'A BMW XM nettó listaára a kiviteltől és a felszereltségtől függ, a feltüntetett ártól indul (XM 50e). Magánszemélyként akár 19% német áfával rendelheted a müncheni Caradvance GmbH-n keresztül — pontos árajánlatért keress minket.' },
      { q: 'Milyen kivitelben érhető el az XM?', a: 'A G09 XM elérhető XM 50e (476 LE, sorhatos plug-in hibrid) és a csúcs XM Label (748 LE, V8-as plug-in hibrid) kivitelben. Mindkettő M xDrive összkerékhajtással és 8 fokozatú M Steptronic váltóval érkezik. Segítünk kiválasztani a hozzád illő változatot.' },
      { q: 'Milyen erős és gyors az XM Label?', a: 'A csúcs XM Label a 4,4 literes V8-as M TwinPower Turbo és elektromos hajtás kombinációjával 748 LE-t (550 kW) és 1000 Nm nyomatékot ad le, M xDrive összkerékhajtással 0-ról 100 km/h-ra 3,8 másodperc alatt gyorsul, végsebessége 250 km/h (M Driver csomaggal 270 km/h).' },
      { q: 'Mekkora az XM tisztán elektromos hatótávja?', a: 'Az XM plug-in hibrid M Hybrid hajtása a kiviteltől függően akár kb. 83 km tisztán elektromos, helyi kibocsátásmentes vezetést tesz lehetővé (WLTP) — ideális a városi közlekedéshez.' },
      { q: 'Mekkora az XM csomagtartója?', a: 'A BMW XM csomagtartója 527 liter, amely a hátsó ülések lehajtásával akár 1820 literre bővíthető.' },
      { q: 'Mennyivel olcsóbb a német áfás vásárlás?', a: 'Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár 19%-os német áfával vásárolhatsz a hazai 27% helyett. A 8 százalékpontnyi különbség egy új BMW XM-nél több millió forintos megtakarítást is jelenthet.' },
      { q: 'Lehet a BMW XM-et lízingelni vagy finanszírozni?', a: 'Igen — a BMW XM elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha nem szeretnél tulajdonolni, <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet.' },
      { q: 'Bérelhető is a BMW XM?', a: 'Igen — az XM <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető, egyetlen, kiszámítható havi díjjal, amiben a szerviz és a biztosítás is benne lehet.' },
      { q: 'Mennyi idő a behozatal?', a: 'A kiválasztott konfigurációtól függ, jellemzően néhány hét. A <a href="/beszerzesi-folyamat">beszerzési folyamat</a> minden lépését mi intézzük, a honosítással és forgalomba helyezéssel együtt.' },
    ],
    related: [
      { name: 'BMW X6', href: '/egyedi-auto-rendeles/x6-dizel' },
      { name: 'BMW X5', href: '/egyedi-auto-rendeles/x5-dizel' },
      { name: 'BMW M4', href: '/egyedi-auto-rendeles/m4-benzin' },
      { name: 'BMW iX3 (elektromos)', href: '/egyedi-auto-rendeles/ix3-elektromos' },
    ],
    schema: {
      modelName: 'XM Label', modelDate: '2026', bodyTypeEn: 'SUV', doors: 5,
      transmission: '8 fokozatú M Steptronic', drive: 'AllWheelDriveConfiguration',
      fuelType: 'Plug-in hibrid', engineFuel: 'Benzin', powerKw: 550, torqueNm: 1000,
      vmaxKmh: 250, accelSec: 3.8, cargoL: 527, consL: 5.3,
    },
  },
  'x3-benzin': {
    slug: 'x3-benzin',
    brand: 'BMW', brandKey: 'bmw', brandLogo: '/bmw-hero-logo.png',
    name: 'BMW X3', modelCode: 'G45',
    title: 'BMW X3 (2024, új generáció) — prémium SUV Németországból | CarAdvance',
    description: 'Új BMW X3 (G45) egyedi rendelése Németországból — benzin mild-hybrid, dízel és plug-in hibrid, xDrive, Curved Display. Kulcsrakész behozatal, akár 19% német áfával. Ár, felszereltség, tartós bérlet.',
    netEur: 50672,
    orderKey: 'x3', orderFuels: 'Benzin,Dízel,Plug-in hibrid',
    heroSub: 'Az új, G45 generációs X3 Németországból — xDrive összkerékhajtás, mild-hybrid, dízel és plug-in hibrid hajtás, BMW Curved Display, új autóként, egyedi konfigurációval.',
    heroVideo: '/bmw/x3-hero.mp4',
    heroPoster: '/bmw/x3-hero-poster.webp',
    mainImg: '/bmw/bmw-x3-hero.webp',
    mainAlt: 'BMW X3 20 xDrive – új generációs prémium SUV Németországból, egyedi rendelés',
    chips: ['Prémium SUV', 'xDrive', 'Mild-hybrid', 'Automata'],
    yearChip: '2026 · Németország',
    bodyType: 'Prémium SUV',
    overviewH2: 'Új BMW X3 Németországból, egyedi rendelésre',
    overviewLead: 'A <strong>BMW X3</strong> a márka legnépszerűbb prémium SUV-ja, a teljesen új <strong>G45</strong> generációban: markánsabb formavilág, világító <strong>Iconic Glow</strong> veserács, digitális <strong>BMW Curved Display</strong> és széles hajtáslánc-kínálat — <strong>benzin mild-hybrid (20 xDrive)</strong>, <strong>dízel (20d)</strong> és <strong>plug-in hibrid (30e)</strong>. A CarAdvance-nél pontosan azt az X3-at rendeljük meg neked, amelyiket szeretnéd — új autóként, gyári felszereltséggel, <a href="/beszerzesi-folyamat">Németországból, kulcsrakész behozatallal</a>. Nem szeretnél venni? Az X3 <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető.',
    highlights: [
      { icon: '◈', title: 'xDrive, 208 LE', text: 'A 20 xDrive benzin mild-hybrid 208 LE-vel és 8 fokozatú automatával — összkerékhajtás minden körülményre.' },
      { icon: '⛽', title: 'Benzin, dízel vagy PHEV', text: 'Válaszd a takarékos 20d dízelt, a benzines mild-hybridet vagy a tölthető 30e plug-in hibridet.' },
      { icon: '▦', title: 'BMW Curved Display', text: '14,9&quot; ívelt kijelző, Iconic Glow veserács, hangulatvilágítás és a legújabb BMW operációs rendszer.' },
      { icon: '€', title: 'Kedvező német ár', text: 'Magánszemélyként akár 19% német áfával — több százezer forint megtakarítás egy új X3-nál.' },
    ],
    design: {
    ...
    interior: {
      ...
      text: 'Az X3 utastere modern és letisztult: a 14,9&quot; BMW Curved Display, a BMW Smartbar, a hangulatvilágítás és a fenntartható, újrahasznosított anyagok teljesen új digitális élményt adnak. A 570–1700 literes csomagtartó a családi és hosszú távú használatra egyaránt ideális.',
      bullets: ['14,9&quot; BMW Curved Display, Smartbar', '15 színű hangulatvilágítás, fenntartható anyagok', 'Vezeték nélküli Apple CarPlay / Android Auto'],
      img: '/bmw/bmw-x3-belso.webp', alt: 'BMW X3 belső tér – BMW Curved Display',
    },
    prose: {
      h2: 'Új BMW X3 Németországból — miért éri meg?',
      blocks: [
        { html: 'A <strong>BMW X3</strong> évek óta a közepes prémium SUV egyik legkeresettebb modellje: tágas, sokoldalú, mégis sportos vezetési élményt kínál. Ha új autót szeretnél, a német piac kínálata nagyságrendekkel szélesebb a hazainál — így pontosan azt a hajtásláncot, felszereltséget, színt és konfigurációt találjuk meg neked, amit elképzeltél. A CarAdvance 2003 óta hozza be a prémium autókat Németországból, <a href="/beszerzesi-folyamat">kulcsrakészen, teljes ügyintézéssel</a>.' },
        { h3: 'Melyik X3 hajtáslánc való nekem?', html: 'A <strong>20d dízel</strong> (197 LE) a nagy futásteljesítményű, hosszú utakat járó tulajdonosok kedvence — kiváló fogyasztás. A benzines <strong>20 xDrive mild-hybrid</strong> (208 LE) kulturált és erős. Aki tölteni is szeretne, a <strong>30e plug-in hibrid</strong> jelentős tisztán elektromos hatótávot ad, a csúcs <strong>M50 xDrive</strong> pedig hatcilinderes M Performance teljesítményt. Segítünk kiválasztani a hozzád illő kivitelt.' },
        { h3: 'Mennyibe kerül egy új BMW X3?', html: 'A <strong>BMW X3 ára</strong> a hajtáslánctól és a felszereltségtől függ, az induló <strong>20 xDrive</strong> a feltüntetett nettó ártól indul. Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár <strong>19%-os német áfával</strong> vásárolhatsz a hazai 27% helyett — ez több százezer forintos megtakarítást is jelenthet.' },
        { h3: 'Megvásárolod, lízingeled vagy béreled?', html: 'Ahogy neked a legjobb: az egyedi rendelés mellett az X3 elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha pedig nem szeretnél tulajdonolni, a modell <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet. Nagyobb SUV-t keresel? Nézd meg a <a href="/egyedi-auto-rendeles/x5-dizel">BMW X5</a> és az <a href="/egyedi-auto-rendeles/ix3-elektromos">elektromos iX3</a> modelleket is.' },
      ],
    },
    variants: [
    ...
    gallery: [
      ...
      { img: '/bmw/bmw-x3-elol34.webp', alt: 'BMW X3 elölnézet háromnegyedből' },
      { img: '/bmw/bmw-x3-studio.webp', alt: 'BMW X3 stúdiófotó, elölnézet' },
      ...
      { img: '/bmw/bmw-x3-cockpit.webp', alt: 'BMW X3 vezetőtér – BMW Curved Display' },
      { img: '/bmw/bmw-x3-ulesek.webp', alt: 'BMW X3 sportülések, prémium utastér' },
      { img: '/bmw/bmw-x3-hatso-ulesek.webp', alt: 'BMW X3 hátsó ülések, tágas utastér' },
    ],
    faq: [
      { q: 'Mennyibe kerül egy új BMW X3 Németországból?', a: 'A BMW X3 nettó listaára a hajtáslánctól és a felszereltségtől függ, a feltüntetett ártól indul. Magánszemélyként akár 19% német áfával rendelheted a müncheni Caradvance GmbH-n keresztül — pontos árajánlatért keress minket.' },
      { q: 'Milyen hajtásláncok érhetők el az új X3-hoz?', a: 'Az új G45 X3 elérhető 20 xDrive benzin mild-hybrid, 20d dízel, 30e plug-in hibrid, valamint a csúcs M50 xDrive kivitelben. A legtöbb változat xDrive összkerékhajtással és 8 fokozatú automata váltóval érkezik.' },
      { q: 'Milyen erős és gyors az X3 20 xDrive?', a: 'A benzines 20 xDrive mild-hybrid 208 LE-t (153 kW) ad le, xDrive összkerékhajtással, 0-ról 100 km/h-ra 7,8 másodperc alatt gyorsul, végsebessége 215 km/h.' },
      { q: 'Mekkora az X3 csomagtartója?', a: 'Az új BMW X3 csomagtartója 570 liter, amely a hátsó ülések lehajtásával akár 1700 literre bővíthető — ideális családi és hosszú távú használatra egyaránt.' },
      { q: 'Mennyivel olcsóbb a német áfás vásárlás?', a: 'Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár 19%-os német áfával vásárolhatsz a hazai 27% helyett. A 8 százalékpontnyi különbség egy új BMW X3-nál több százezer forintos megtakarítást jelenthet.' },
      { q: 'Lehet a BMW X3-at lízingelni vagy finanszírozni?', a: 'Igen — a BMW X3 elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha nem szeretnél tulajdonolni, <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet, szervizzel és biztosítással együtt.' },
      { q: 'Bérelhető is a BMW X3?', a: 'Igen — az X3 <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető, egyetlen, kiszámítható havi díjjal, amiben a szerviz és a biztosítás is benne lehet.' },
      { q: 'Mennyi idő a behozatal?', a: 'A kiválasztott konfigurációtól függ, jellemzően néhány hét. A <a href="/beszerzesi-folyamat">beszerzési folyamat</a> minden lépését mi intézzük, a honosítással és forgalomba helyezéssel együtt.' },
    ],
    related: [
      { name: 'BMW X5', href: '/egyedi-auto-rendeles/x5-dizel' },
      { name: 'BMW iX3 (elektromos)', href: '/egyedi-auto-rendeles/ix3-elektromos' },
      { name: 'BMW X1', href: '/egyedi-auto-rendeles?brand=bmw' },
      { name: 'BMW X4', href: '/egyedi-auto-rendeles?brand=bmw' },
    ],
    schema: {
      modelName: 'X3 20 xDrive', modelDate: '2024', bodyTypeEn: 'SUV', doors: 5,
      transmission: '8 fokozatú automata (Steptronic)', drive: 'AllWheelDriveConfiguration',
      fuelType: 'Benzin (mild-hybrid)', engineFuel: 'Benzin', powerKw: 153, torqueNm: 330,
      vmaxKmh: 215, accelSec: 7.8, cargoL: 570, consL: 7.6,
    },
  },
  ...
  'x6-dizel': {
    slug: 'x6-dizel',
    brand: 'BMW', brandKey: 'bmw', brandLogo: '/bmw-hero-logo.png',
    name: 'BMW X6', modelCode: 'G06',
    title: 'BMW X6 — prémium SUV Coupé Németországból | CarAdvance',
    description: 'Új BMW X6 (G06) egyedi rendelése Németországból — dízel, benzin mild-hybrid és M60i, xDrive, coupé-sziluett, Iconic Glow veserács. Kulcsrakész behozatal, akár 19% német áfával. Ár, felszereltség, tartós bérlet.',
    netEur: 82437,
    orderKey: 'x6b', orderFuels: 'Benzin,Dízel',
    heroSub: 'A markáns coupé-SUV Németországból — xDrive összkerékhajtás, mild-hybrid dízel és benzin hajtás, BMW Curved Display, új autóként, egyedi konfigurációval.',
    heroVideo: '',
    heroPoster: '/bmw/bmw-x6-hero.webp',
    mainImg: '/bmw/bmw-x6-hero.webp',
    mainAlt: 'BMW X6 xDrive40d – prémium SUV Coupé Németországból, egyedi rendelés',
    chips: ['SUV Coupé', 'xDrive', 'Mild-hybrid', 'Automata'],
    yearChip: '2026 · Németország',
    bodyType: 'SUV Coupé',
    overviewH2: 'Új BMW X6 Németországból, egyedi rendelésre',
    overviewLead: 'A <strong>BMW X6</strong> a márka ikonikus <strong>SUV Coupéja</strong>: az X5 tágasságát és technikáját ötvözi egy sportos, lecsapott tetővonalú, karakteres sziluettel. A <strong>G06</strong> a világító <strong>Iconic Glow</strong> veseráccsal, digitális <strong>BMW Curved Display</strong>-jel és széles hajtáslánc-kínálattal érkezik — <strong>dízel (40d)</strong>, <strong>benzin mild-hybrid (40i)</strong> és a csúcs <strong>M60i</strong>. A CarAdvance-nél pontosan azt az X6-ot rendeljük meg neked, amelyiket szeretnéd — új autóként, gyári felszereltséggel, <a href="/beszerzesi-folyamat">Németországból, kulcsrakész behozatallal</a>. Nem szeretnél venni? Az X6 <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető.',
    highlights: [
      { icon: '◈', title: 'xDrive, akár 530 LE', text: 'A 40d dízeltől (340 LE) a csúcs V8-as M60i-ig (530 LE) — összkerékhajtás és 8 fokozatú automata.' },
      { icon: '⚡', title: 'Coupé-sziluett', text: 'Lecsapott tetővonal, széles hátsó rész és sportos arányok — az X6 minden szemszögből jelenség.' },
      { icon: '▦', title: 'BMW Curved Display', text: 'Ívelt digitális kijelző, Iconic Glow veserács, hangulatvilágítás és a legújabb BMW operációs rendszer.' },
      { icon: '€', title: 'Kedvező német ár', text: 'Magánszemélyként akár 19% német áfával — egy X6-nál ez több millió forint megtakarítást is jelenthet.' },
    ],
    design: {
      h3: 'Sportos jelenlét, coupé-arányok',
      text: 'Az X6 az X5-nél sportosabb, dinamikusabb megjelenést kínál: hosszú motorháztető, lecsapott tetővonal és izmos hátsó rész. A választhatóan világító veserács és a keskeny fényszóró-grafika markáns arcot adnak. Pontosan úgy konfigurálva, ahogy te szeretnéd.',
      bullets: ['Iconic Glow világító veserács', 'Adaptív LED / Laser fényszórók', '20–22&quot; könnyűfém keréktárcsák, M Sport csomagok'],
      img: '/bmw/bmw-x6-oldal.webp', alt: 'BMW X6 külső – oldalnézet, coupé-sziluett',
    },
    interior: {
      h3: 'BMW Curved Display, sportos prémium utastér',
      text: 'Az X6 utastere a vezetőre koncentrál: ívelt BMW Curved Display, sportos ülések, prémium anyagok és hangulatvilágítás. A coupé-tetővonal ellenére a tér és az 580 literes csomagtartó is kényelmes a mindennapokban.',
      bullets: ['BMW Curved Display, legújabb operációs rendszer', 'Sport- vagy komfortülések, prémium bőr', 'Vezeték nélküli Apple CarPlay / Android Auto'],
      img: '/bmw/bmw-x6-cockpit.webp', alt: 'BMW X6 belső tér – BMW Curved Display',
    },
    prose: {
      h2: 'Új BMW X6 Németországból — miért éri meg?',
      blocks: [
        { html: 'A <strong>BMW X6</strong> annak szól, aki a nagy prémium SUV tágasságát sportos, egyedi formában szeretné. Ha új autót rendelnél, a német piac kínálata nagyságrendekkel szélesebb a hazainál — így pontosan azt a hajtásláncot, felszereltséget, színt és konfigurációt találjuk meg neked, amit elképzeltél. A CarAdvance 2003 óta hozza be a prémium autókat Németországból, <a href="/beszerzesi-folyamat">kulcsrakészen, teljes ügyintézéssel</a>.' },
        { h3: 'Melyik X6 hajtáslánc való nekem?', html: 'A <strong>40d dízel</strong> (340 LE, 700 Nm) a nagy futásteljesítményű, hosszú utakat járó tulajdonosok kedvence. A benzines <strong>40i</strong> kulturált és erős. Aki a csúcsot keresi, annak a V8-as <strong>M60i</strong> (530 LE) igazi M Performance élményt ad. Segítünk kiválasztani a hozzád illő kivitelt.' },
        { h3: 'Mennyibe kerül egy új BMW X6?', html: 'A <strong>BMW X6 ára</strong> a hajtáslánctól és a felszereltségtől függ. Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár <strong>19%-os német áfával</strong> vásárolhatsz a hazai 27% helyett — egy ekkora autónál ez több millió forintos megtakarítást is jelenthet. Pontos árajánlatért keress minket.' },
        { h3: 'Megvásárolod, lízingeled vagy béreled?', html: 'Ahogy neked a legjobb: az egyedi rendelés mellett az X6 elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha pedig nem szeretnél tulajdonolni, a modell <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet. A klasszikusabb formát keresed? Nézd meg a <a href="/egyedi-auto-rendeles/x5-dizel">BMW X5</a> modellt is.' },
      ],
    },
    variants: [
      { key: 'x6-40d', label: 'BMW X6 xDrive40d', fuel: 'Dízel (mild-hybrid)', power: '340 LE (250 kW)', torque: '700 Nm', drive: 'xDrive összkerék / 8 fok. aut.', accel: '5,3 mp', vmax: '245 km/h', cons: '~6,5 l/100 km', boot: '580–1530 liter', rec: 'Takarékos, erős dízel belépő', img: '/bmw/bmw-x6-hero.webp', alt: 'BMW X6 xDrive40d – elölnézet' },
    ],
    gallery: [
      { img: '/bmw/bmw-x6-eleje.webp', alt: 'BMW X6 elölnézet' },
      { img: '/bmw/bmw-x6-menet.webp', alt: 'BMW X6 menet közben, elölnézet háromnegyedből' },
      { img: '/bmw/bmw-x6-hatso34.webp', alt: 'BMW X6 hátsó háromnegyedes nézet' },
      { img: '/bmw/bmw-x6-menet2.webp', alt: 'BMW X6 menet közben' },
      { img: '/bmw/bmw-x6-hatso.webp', alt: 'BMW X6 hátsó nézet' },
      { img: '/bmw/bmw-x6-veserac.webp', alt: 'BMW X6 Iconic Glow világító veserács' },
      { img: '/bmw/bmw-x6-felni.webp', alt: 'BMW X6 M könnyűfém keréktárcsa, közeli nézet' },
      { img: '/bmw/bmw-x6-fenyszoro.webp', alt: 'BMW X6 fényszóró, közeli nézet' },
      { img: '/bmw/bmw-x6-sportules.webp', alt: 'BMW X6 sportülések, prémium bőr utastér' },
      { img: '/bmw/bmw-x6-belso.webp', alt: 'BMW X6 utastér, hátsó rész' },
      { img: '/bmw/bmw-x6-steering.webp', alt: 'BMW X6 vezetőtér – M bőr kormány' },
      { img: '/bmw/bmw-x6-konzol.webp', alt: 'BMW X6 középkonzol, prémium kialakítás' },
    ],
    faq: [
      { q: 'Mennyibe kerül egy új BMW X6 Németországból?', a: 'A BMW X6 nettó listaára a hajtáslánctól és a felszereltségtől függ, a feltüntetett ártól indul. Magánszemélyként akár 19% német áfával rendelheted a müncheni Caradvance GmbH-n keresztül — pontos árajánlatért keress minket.' },
      { q: 'Milyen hajtásláncok érhetők el az X6-hoz?', a: 'A BMW X6 elérhető 40d dízel, 40i benzin mild-hybrid, valamint a csúcs V8-as M60i xDrive kivitelben. Mindegyik xDrive összkerékhajtással és 8 fokozatú automata váltóval érkezik. Segítünk kiválasztani a hozzád illő változatot.' },
      { q: 'Milyen erős és gyors az X6 xDrive40d?', a: 'A dízel xDrive40d 340 LE-t (250 kW) és 700 Nm nyomatékot ad le, xDrive összkerékhajtással, 0-ról 100 km/h-ra 5,3 másodperc alatt gyorsul, végsebessége 245 km/h.' },
      { q: 'Mekkora az X6 csomagtartója?', a: 'A coupé-tetővonal ellenére az X6 csomagtartója 580 liter, amely a hátsó ülések lehajtásával akár 1530 literre bővíthető.' },
      { q: 'Mennyivel olcsóbb a német áfás vásárlás?', a: 'Magánszemélyként a müncheni Caradvance GmbH-n keresztül akár 19%-os német áfával vásárolhatsz a hazai 27% helyett. A 8 százalékpontnyi különbség egy új BMW X6-nál több millió forintos megtakarítást is jelenthet.' },
      { q: 'Lehet a BMW X6-ot lízingelni vagy finanszírozni?', a: 'Igen — a BMW X6 elérhető <a href="/finanszirozas-lizing">finanszírozással és lízinggel</a> is, kiszámítható havidíjjal. Ha nem szeretnél tulajdonolni, <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is a tiéd lehet, szervizzel és biztosítással együtt.' },
      { q: 'Bérelhető is a BMW X6?', a: 'Igen — az X6 <a href="/uj-auto-berlese?brand=bmw">tartós bérletben</a> is elérhető, egyetlen, kiszámítható havi díjjal, amiben a szerviz és a biztosítás is benne lehet.' },
      { q: 'Mennyi idő a behozatal?', a: 'A kiválasztott konfigurációtól függ, jellemzően néhány hét. A <a href="/beszerzesi-folyamat">beszerzési folyamat</a> minden lépését mi intézzük, a honosítással és forgalomba helyezéssel együtt.' },
    ],
    related: [
      { name: 'BMW X5', href: '/egyedi-auto-rendeles/x5-dizel' },
    ...
    schema: {
      modelName: 'X6 xDrive40d', modelDate: '2024', bodyTypeEn: 'SUV', doors: 5,
      transmission: '8 fokozatú automata (Steptronic)', drive: 'AllWheelDriveConfiguration',
      fuelType: 'Dízel (mild-hybrid)', engineFuel: 'Dízel', powerKw: 250, torqueNm: 700,
      vmaxKmh: 245, accelSec: 5.3, cargoL: 580, consL: 6.5,
    },
  },
};
