...
const hu: EladomContent = {
  ...
  charity: {
    ...
    orgs: [
      ...
      { tag: 'Jogvédelem', color: 'linear-gradient(160deg,#4b5563,#2c333d)', logo: `${BASE}/patent-egyesulet.webp`, icon: 'shield', name: 'PATENT Egyesület', text: 'Jogi és lelki segítséget nyújt bántalmazást átélt nőknek és gyerekeknek — a biztonságos újrakezdésért.', url: 'https://patent.org.hu', photo: 'https://images.unsplash.com/photo-1683271687586-2f1224747905?auto=format&fit=crop&w=900&q=72' },
    ],
